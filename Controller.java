...
public class Controller{
	...
	public boolean checkIfLegalForCheck(int rowFrom, int colFrom, int rowTo, int colTo, int positionRank, int[][] positions, int[][] colors) {
		//int move[] = {lastClicked[0], lastClicked[1], justClicked[0], justClicked[1]}; // The lastClicked values are what is going to be moved into the justClicked values
		int move[] = {rowFrom, colFrom, rowTo, colTo}; // The lastClicked values are what is going to be moved into the justClicked values
		...
		//holds the value of what is in the square we are attempting to move from
		int pieceRankNum = positionRank; //lastClicked[2]; //the value at index 2 for lastClicked and justClicked stores what the contents in the square were/are
		System.out.println("The value of the square you last clicked was: "+model.pieceLookup(pieceRankNum)+" ("+pieceRankNum+")");
